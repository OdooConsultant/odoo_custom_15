...
//    var WarningDialog = require('web.CrashManager').WarningDialog;
    ...
    var ksDynamicReportsWidget = AbstractAction.extend({
        ...
        ksPerformOnchange: function (ev) {
            ...
            self.ks_df_report_opt.ks_partner_categories = ev.data.partner_categories;
            ...
            if (this.ks_df_report_opt.ks_partner) {
                if (!this.ksMany2Many) {
                    ...
                    if ('ks_partner_ids' in this.ks_df_report_opt) {
                     ...
                     if ('ks_partner_categories' in this.ks_df_report_opt) {
                        fields['partner_categories'] = {
                            label: _t('Tags'),
                            modelName: 'res.partner.category',
                            value: this.ks_df_report_opt.ks_partner_categories.map(Number),
                        };
                    }
                    if (!_.isEmpty(fields)) {
